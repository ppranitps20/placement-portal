   ...
   <section class="content-header">
      <div class="container">
        <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
          <h2 class="text-center margin-bottom-20 margin-top-20">Create Company Profile</h2>
          <form method="post" id="registerCompanies" action="addcompany.php" enctype="multipart/form-data">
            <div class="col-md-6 latest-job ">
              ...
              <div class="form-group">
                <h4>Brief Info About Your Company: </h4>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <button type="submit" class="btn btn-flat btn-lg">Register</button>
              </div>
              <?php 
