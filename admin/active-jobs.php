            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
               <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="active-jobs.php"><span class="ion-briefcase step-size-32"></span> Active Jobs</a></li>
                  ...
                  <table id="example2" class="table table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="view-job-post.php?id=<?php echo $row['id_jobpost']; ?>"><span class="ion-eye"></span></a></td>
                        <td><a href="delete-job-post.php?id=<?php echo $row['id_jobpost']; ?>"><span class="ion-trash-b"></span></a></td>
                      </tr>  
                            <?php
                        }
                      }
