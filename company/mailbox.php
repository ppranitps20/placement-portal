            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="mailbox.php"><span class="ion-ios-email step-size-32 "></span> Mailbox</a></li>
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <div class="pull-right">
                <a href="create-mail.php" class="btn btn-warning btn-flat"><span class="ion-ios-email step-size-32 "></span> Create</a>
              </div>
              <!-- /.box-tools -->
            </div>
            <!-- /.box-header -->
